    ...
    <div className="Ferramentas">
      ...
      <div className="sessaoTexto">
        <div className="conteudo">
          ...
          <p>Trabalhamos com banco de dados <b style={{ color: "#2F00FF" }}>MySQL</b>, que é um dos mais utilizados no mercado da tecnologia pelas grandes empresas,  criamos a estrutura e base de dados, e deixamos pronta para que possa ser integrada a sua página web.</p>
        </div>
      </div>

      <div className="sessaoTexto">
        <div className="conteudo">
          <h2>Projetos do Figma</h2>
          <p>Transformamos o seu desing do Figma em uma página web, bastar nos compartilhar seu projeto Figma seguindo o seguinte passo:
            1: Com seu projeto Figma aberto, clique em <b style={{ color: "#fff", fontWeight: 12, backgroundColor: "#07A1DE", paddingLeft: 3, paddingRight: 3, borderRadius: 5 }}>Share</b> no canto superior direito.
